...
author: "Christoffer A. E. B. Kristensen"
date: "05/10/2020"
...
It is a good way to make the data, that are large numbers, more compact
2. *Who is the outlier (the richest country in 1952 - far right on x axis)?* 
Kuwait, as can be seen in the code below, where we filter for the richest countries in 1952
...
With the code below you can see colors on the continents
...
Norway, Kuwait, Singapore, US and Ireland. This answer was gotten by useage of the code in question 2
...
I use the code from the previous time, only now i use "labs" to title the....
I write in the console "options(scipen = 999)" in order to turn the log10 off
